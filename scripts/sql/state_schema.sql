...
CREATE TABLE IF NOT EXISTS agents (
  ...
  worktree_path TEXT,
  branch_name TEXT,
  dedicated_worktree INTEGER NOT NULL DEFAULT 1,
  read_only INTEGER NOT NULL DEFAULT 0,
  single_response INTEGER NOT NULL DEFAULT 0,
...
CREATE INDEX IF NOT EXISTS idx_agents_requester ON agents(requester_agent_id, created_at);
